...
var map__28080 = top_item;
var map__28080__$1 = (((((!((map__28080 == null))))?(((((map__28080.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28080.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28080):map__28080);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28080__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28080__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28080__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28074){var _e = e28074;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___28180 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___28180)){
var seen_errors_28181 = temp__5733__auto___28180;
if(cljs.core.truth_(seen_errors_28181.has(self))){
} else {
seen_errors_28181.add(self);

var temp__5735__auto___28182 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___28182)){
var sense_28183 = temp__5735__auto___28182;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28183)].join(''));
} else {
}
}
} else {

...
var o28158 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28158["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28159 = temp__5733__auto____$1;
return (o28159["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27887__auto__ = f;
return (o__27887__auto__["toString"]).call(o__27887__auto__);
} else {
return "";
}
}catch (e28160){var _ = e28160;
return "";
}});
...
try{var o__27887__auto___28388 = t;
(o__27887__auto___28388["cljs$lang$ctorPrWriter"]).call(o__27887__auto___28388,t,writer);
}catch (e28165){var __28389 = e28165;
}
...
var char_code = (function (){var o__27887__auto__ = (new String(char$));
return (o__27887__auto__["charCodeAt"]).call(o__27887__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27887__auto__ = String;
return (o__27887__auto__["fromCharCode"]).call(o__27887__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28231 = num_code;
switch (G__28231) {
case (1):
return (185);
...
var o__27887__auto__ = String;
return (o__27887__auto__["fromCharCode"]).call(o__27887__auto__,superscript_code);
});
/**
...
}catch (e28232){var _e__27910__auto__ = e28232;
return false;
}})())){
...
var vec__28236 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28236,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28246){
var vec__28247 = p__28246;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28247,(0),null);
...
var G__28412 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__28413 = cljs.core.butlast(remaining_tokens);
name_tokens = G__28412;
remaining_tokens = G__28413;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28243){
var G__28244 = cljs.core.first(seq28243);
var seq28243__$1 = cljs.core.next(seq28243);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28244,seq28243__$1);
}));
...
var vec__28254 = cljs.core.split_with((function (p1__28253_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28253_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28254,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28254,(1),null);
...
var vec__28265 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28265,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28265,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__28416 = cljs.core.rest(remaining_tokens);
var G__28417 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__28416;
name_tokens = G__28417;
continue;
} else {
...
var vec__28275 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28275,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28275,(1),null);
var vec__28278 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28278,(1),null);
var vec__28281 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28281,(3),null);
...
var vec__28286 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28286,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28289 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28289,(1),null);
var vec__28292 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28298 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28298) : devtools.munging.parse_fn_info_deep.call(null,G__28298));
})()));
}
} else {
return fn_info;
...
var G__28437 = (arity + (1));
var G__28438 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28310){
var vec__28311 = p__28310;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28311,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28311,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28318_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28318_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28319_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28319_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___28452 = arguments.length;
var i__4737__auto___28453 = (0);
while(true){
if((i__4737__auto___28453 < len__4736__auto___28452)){
args__4742__auto__.push((arguments[i__4737__auto___28453]));

var G__28454 = (i__4737__auto___28453 + (1));
i__4737__auto___28453 = G__28454;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28322){
var vec__28323 = p__28322;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28323,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28320){
var G__28321 = cljs.core.first(seq28320);
var seq28320__$1 = cljs.core.next(seq28320);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28321,seq28320__$1);
}));
...
var map__28339 = options;
var map__28339__$1 = (((((!((map__28339 == null))))?(((((map__28339.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28339.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28339):map__28339);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28339__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28339__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28339__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28339__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28340 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28340,(5),null);
...
var o__27887__auto__ = f;
return (o__27887__auto__["getBasis"]).call(o__27887__auto__);
});
/**
...
}catch (e28353){var _e__27910__auto__ = e28353;
...
var G__28473 = (obj[cljs.core.first(path)]);
var G__28474 = cljs.core.rest(path);
obj = G__28473;
path = G__28474;
continue;
} else {
...
var _STAR_ = (function (accum,p__28366){
var vec__28367 = p__28366;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28367,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28367,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28370){
var vec__28371 = p__28370;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28371,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28371,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28371,(2),null);
...
var post_process = (function (p__28379){
var vec__28380 = p__28379;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28380,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28377_SHARP_){
return (obj[cljs.core.first(p1__28377_SHARP_)]);
}),sorted_matches);

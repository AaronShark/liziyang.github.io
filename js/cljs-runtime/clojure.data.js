...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__27708){
...
var clojure$data$EqualityPartition$equality_partition$dyn_27974 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_27974(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_27989 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_27989(a,b);
}
});
...
var fexpr__27862 = (function (){var G__27863 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27863__$1)].join('')));

}
})();
return (fexpr__27862.cljs$core$IFn$_invoke$arity$2 ? fexpr__27862.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__27862.call(null,a,b));
}));
/**

...
var G__28440 = devtools.prefs.pref(v);
v = G__28440;
continue;
} else {
return v;
...
}catch (e28393){var _e__27910__auto__ = e28393;
return false;
}})();
...
}catch (e28398){var _e__27910__auto__ = e28398;
return false;
}})();
...
}catch (e28404){var _e__27910__auto__ = e28404;
return false;
}}
}
});
...
var vec__28422 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28422,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28422,(1),null);
...
return cljs.core.some((function (p1__28433_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28433_SHARP_);
}),template);
});

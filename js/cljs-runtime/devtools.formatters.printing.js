...
var G__28535 = (i__4737__auto___28533 + (1));
i__4737__auto___28533 = G__28535;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28455){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28456,G__28457,seq28455__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28486_SHARP_){
return (!((cljs.core.meta(p1__28486_SHARP_) == null)));
})))){
...
var map__28495 = opts;
var map__28495__$1 = (((((!((map__28495 == null))))?(((((map__28495.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28495.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28495):map__28495);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28495__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28499){var _e__27910__auto__ = e28499;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e28501){var _e__27910__auto__ = e28501;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28511 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28512 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28512);

try{var map__28513 = opts;
var map__28513__$1 = (((((!((map__28513 == null))))?(((((map__28513.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28513.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28513):map__28513);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28513__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28511);
}});
...
var temp__5733__auto___28562 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___28562)){
var managed_print_level_28563 = temp__5733__auto___28562;
var _STAR_print_level_STAR__orig_val__28519_28564 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28520_28565 = managed_print_level_28563;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28520_28565);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28518_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28518_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28519_28564);
}} else {
job_fn();
}
